Ext.define('app.view.platform.systemattach.FileBatchPreview', {
	extend: 'Ext.panel.Panel',
    alternateClassName: 'FileBatchPreview',
	xtype: 'filebatchpreview',
	plugins:[{ptype:'PRQ'}],
	requires: [
        'app.view.platform.systemattach.UploadGrid'
    ],
	...
	initComponent:function(){
		...
		var P_grid = Ext.create("Ext.grid.Panel",{reference:'P_grid',paging:true,selType: 'checkboxmodel',
    		tbar:[
    		...
    		columns:[
    			{xtype:'actioncolumn',header:"文件名", flex:1, align:"left", sortable:true, dataIndex:"originalname",qcfg:{type:'string'},items: [{
				...
				{header:"预览次数", width:80, align:"center",menuDisabled:true,sortable:false,dataIndex:"viewnum"},
				{header:"下载次数", width:80, align:"center",menuDisabled:true,sortable:false, dataIndex:"downloadnum"}
    		]
		});
    	this.items = P_grid;
