...
Ext.define('app.view.bussiness.device.DeviceChart', {
	extend : 'Ext.panel.Panel',
	alternateClassName : 'DeviceChart',
	xtype : 'deviceChart',
	requires : ['app.controller.bussiness.device.DeviceChartController',
			'app.view.bussiness.device.DeviceEdit'],
	controller : 'deviceChart',
	referenceHolder : true,
	layout : 'border',
	constructor : function(parament) {
		Ext.apply(this, parament);
		this.callParent(arguments);
	},
	initComponent : function(parament) {

		Ext.Msg.alert('textClass属性122112', this.id + ' ' + this.title + ' urlparament'
						+ this.urlparament);
		alert("initComponentDeviceChart22");
		this.items = [{
					xtype : 'treepanel',
					title : '',
					region : 'west',
