package com.distribution.wamoli.common.attachment;

import com.distribution.wamoli.common.utils.DateTimeUtils;
import com.distribution.wamoli.common.utils.DownloadUtils;
...
public class LocalhostAttachmentImpl implements AttachmentService {
    ...
    public String upload(InputStream inputStream,String type) throws IOException {
        String fileName=this.getFileName(type);
        FileUtils.saveFile(inputStream, properties.getWamoli().getAttachPath() + fileName);
        return fileName;
    }
    ...
    public String getPath() {
        StringBuffer sb = new StringBuffer();
        sb.append(properties.getWamoli().getAttachPath());
        sb.append("/");
        return sb.toString();
    }
