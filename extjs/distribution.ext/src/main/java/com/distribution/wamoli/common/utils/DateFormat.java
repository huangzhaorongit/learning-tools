...
import com.distribution.wamoli.common.exception.PreglacialDateParseException;
...
public class DateFormat {
	...
	public static DateFormat valueOf(int type) {
		switch(type) {
			case VALUE_yyyyMMdd: return FORMAT_yyyyMMdd;
			case VALUE_yyyyMMddHHmmss: return FORMAT_yyyyMMddHHmmss;
			case VALUE_HHmmss: return FORMAT_HHmmss;
			default : throw new PreglacialDateParseException(" is not parse formattype:'"+type+"'! ");
		}
	}
	...
	public String getJavaFormat() {
		switch(type) {
			case VALUE_yyyyMMdd: return "yyyy-MM-dd";
			case VALUE_yyyyMMddHHmmss: return "yyyy-MM-dd HH:mm:ss";
			case VALUE_HHmmss: return "HH:mm:ss";
			default : return "";
		}
	}
	...
	public String getOracleFormat() {
		switch(type) {
			case VALUE_yyyyMMdd: return "yyyy-mm-dd";
			case VALUE_yyyyMMddHHmmss: return "yyyy-mm-dd hh24:mi:ss";
			case VALUE_HHmmss: return "hh24:mi:ss";
			default : return "";
		}
	}
	...
	public String getMySQLFormat() {
		switch(type) {
			case VALUE_yyyyMMdd: return "%Y-%m-%d";
			case VALUE_yyyyMMddHHmmss: return "%Y-%m-%d %H:%i:%S";
			case VALUE_HHmmss: return "%H:%i:%S";
			default : return "";
		}
	}
