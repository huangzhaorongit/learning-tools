...
public class MapUtils extends org.apache.commons.collections.MapUtils {
	 ...
	 * @throws NoSuchMethodException
	 */
	public static <T> Collection<Map<String, String>> toMapCollection(Collection<T> collection) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	 ...
	 * @throws NoSuchMethodException
	 */
	public static <T> List<Map<String, String>> toMapList(Collection<T> collection) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		List<Map<String, String>> retList = new ArrayList<Map<String, String>>();
		if (collection != null && !collection.isEmpty()) {
			for (Object object : collection) {
				Map<String, String> map = toMap(object);
	 ...
	 * @throws NoSuchMethodException
	 */
	public static <T> List<Map<String, Object>> toMapObjectList(Collection<T> collection) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		List<Map<String, Object>> retList = new ArrayList<Map<String, Object>>();
		if (collection != null && !collection.isEmpty()) {
			for (Object object : collection) {
				
				
				Map<String, Object> map = BeanUtils.transBean2Map(object);
				retList.add(map);
			}
		}
		return retList;
