 ...
 */
Ext.define('app.view.platform.design.sortScheme.SetFields', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.setsortfields',

	requires : ['app.view.platform.design.sortScheme.SetFieldsController',
			'app.view.platform.design.CanSelectedFieldsTree',
			'app.view.platform.design.sortScheme.SelectedFieldsTree',
			'app.view.platform.design.ModuleHierarchy'],
	controller : 'setsortfields',
	viewModel : {
		data : {
	...
	initComponent : function() {
		...
		this.items = [{
					...
					xtype : 'moduleselectedsortfieldstree',
					region : 'center',
					flex : 1,
